...
public class RunnerManager {
    ...
    public void updateCompereRunnersLiveTrial(RunnerLiveTrial runner1, RunnerLiveTrial runner2, RunnerLiveTrial runner3) {
        ...
        this.compereRunners.add(new Runner(runner1.getName(), runner1.getSurname(), runner1.getDorsal(), runner1.getCountry(), runner1.getClub(), runner1.getCio(), runner1.getGapTime(), runner1.getSex(), runner1.getPosition(), runner1.getPuntDePas()));
        this.compereRunners.add(new Runner(runner2.getName(), runner2.getSurname(), runner2.getDorsal(), runner2.getCountry(), runner2.getClub(), runner2.getCio(), runner2.getGapTime(), runner2.getSex(), runner2.getPosition(), runner2.getPuntDePas()));
        this.compereRunners.add(new Runner(runner3.getName(), runner3.getSurname(), runner3.getDorsal(), runner3.getCountry(), runner3.getClub(), runner3.getCio(), runner3.getGapTime(), runner3.getSex(), runner3.getPosition(), runner3.getPuntDePas()));
    }
